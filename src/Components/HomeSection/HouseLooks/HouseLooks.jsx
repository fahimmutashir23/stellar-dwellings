      ...
      <div className="flex flex-col items-center justify-center">
        <div className="flex flex-col  max-w-7xl justify-center items-center space-y-3 w-full ">
          ...
          <div className="flex flex-col lg:flex-row space-x-2 space-y-3 md:space-x-6   w-[90vw] items-center justify-center ">
            <div className="lg:w-40  w-64 h-40    hover:shadow-orange-500 shadow-[0_0_50px_#00000028] duration-300 overflow-hidden hover:scale-105 rounded-xl ">
              <img
            ...
            <div className="flex flex-row lg:flex-col space-x-3 space-y-6 items-center justify-center">
              <div className="w-32 lg:w-40 h-32 hover:shadow-orange-500 shadow-[0_0_50px_#00000028] duration-300 hover:scale-105 overflow-hidden rounded-xl ">
                <img
              ...
              <div className="w-32 lg:w-40 h-48  hover:shadow-orange-500 shadow-[0_0_50px_#00000028] duration-300  overflow-hidden hover:scale-105 rounded-xl ">
                <img
            ...
            <div className="lg:w-60 w-64 h-96 hover:shadow-orange-500 shadow-[0_0_50px_#00000028] duration-300   overflow-hidden hover:scale-105 rounded-xl ">
              <img
            ...
            <div className="flex flex-row lg:flex-col space-x-3 space-y-6 items-center justify-center ">
              ...
              <div className="w-32 lg:w-40 h-32 hover:shadow-orange-500 shadow-[0_0_50px_#00000028] duration-300  overflow-hidden hover:scale-105 rounded-xl ">
                <img
