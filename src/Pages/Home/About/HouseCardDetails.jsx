    ...
    <div className="" style={{
        ...
        <div className=" bg-[#000000B2]">
          <div className=" max-w-screen-2xl mx-auto py-24">
            <h2 className="md:text-6xl text-2xl font-bold text-white font-serif px-14">Property Details</h2>
            <div className="mt-2 px-14">
              <p className="text-white">
                <Link to="/" className="hover:text-[#ec3323] cursor-pointer">
                  Home{" "}
                </Link>
                / <span className="text-[#ec3323]">Details</span>
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="main_details px-5 md:px-0 md:w-3/4">
            <div className="mb-16">
              <div className="flex justify-between">
                <h2 className="lg:text-3xl poppins-font mb-[12px] font-semibold text-black">
                  property_title
                </h2>
                <p className="text-[#ec3323] inline-block md:text-lg font-bold mt-1">
                  $property_price
                </p>
              </div>
              <div className="flex md:flex-row flex-col justify-between text-[#666666]">
                <p className="flex lg:text-base items-center gap-2 ">
                  <CiLocationOn className="text-[#e33226] text-xs" />
                  ...
                  <button>
                    <FaBookmark
                      ...
                      className="lg:text-xl text-[#ec3323]"
                    />
                  </button>
            ...
            <div className="">
              <div><h3 className="poppins-font text-[24px] font-semibold my-6">
                Property Video
              </h3>
...
//      <div className=" bg-[#000000B2]">
//        <div className=" md:max-w-screen-2xl mx-auto p-24">
//          <h2 className="lg:text-6xl font-bold text-white font-serif">
//            Property Details
//          </h2>
//          <div className="mt-2">
//             <p className="text-white">
...
//                   Home{" "}
//                 </Link>
//                 / <span className="text-[#ec3323]">Property Details</span>
//               </p>
//          </div>
//        </div>
//      </div>
